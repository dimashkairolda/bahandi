...
import 'create_defect_from_reglament_model.dart';
export 'create_defect_from_reglament_model.dart';

class CreateDefectFromReglamentWidget extends StatefulWidget {
  const CreateDefectFromReglamentWidget({
    super.key,
    this.workable,
    this.equipId,
    this.departmentid,
  ...
  static String routeName = 'CreateDefectFromReglament';
  static String routePath = '/createDefectFromReglament';

  @override
  State<CreateDefectFromReglamentWidget> createState() =>
      _CreateDefectFromReglamentWidgetState();
}

class _CreateDefectFromReglamentWidgetState
    extends State<CreateDefectFromReglamentWidget> {
  late CreateDefectFromReglamentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateDefectFromReglamentModel());
