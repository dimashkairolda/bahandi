...
import 'request_put_body.dart';
export 'detailed_defects_offline_model.dart';

bool _attachmentItemIsVideo(dynamic item) {
  final url = getJsonField(item, r'''$.url''').toString();
  if (url.isEmpty || url == 'null') {
    return false;
  }
  final ext = functions.getFileExtension(url).toLowerCase();
  return ext == 'mov' ||
      ext == 'mp4' ||
      ext == 'webm' ||
      ext == 'm4v' ||
...
String _attachmentItemDisplayName(dynamic item) {
  final name = getJsonField(item, r'''$.name''')?.toString();
  if (name != null && name.isNotEmpty && name != 'null') {
    return name;
  }
  final orig = getJsonField(item, r'''$.original_filename''')?.toString();
  if (orig != null && orig.isNotEmpty && orig != 'null') {
    return orig;
  }
  final url = getJsonField(item, r'''$.url''').toString();
  if (url.isEmpty || url == 'null') {
...
String _attachmentFullMediaUrl(String url) {
  if (url.isEmpty || url == 'null') {
    return '';
  }
  ...
  return 'https://app.etry.kz$url';
}

String _videoUploadPhaseLabel(BuildContext context, String phase) {
  if (phase == 'compress') {
    return FFLocalizations.of(context).getVariableText(
      ruText: 'Сжатие видео…',
      kkText: 'Бейнені сығымдау…',
    );
  }
  if (phase == 'upload') {
    return FFLocalizations.of(context).getVariableText(
      ruText: 'Загрузка на сервер…',
      kkText: 'Серверге жүктеу…',
    );
  }
  if (phase == 'save') {
    return FFLocalizations.of(context).getVariableText(
      ruText: 'Сохранение заявки…',
...
class _DetailedDefectsOfflineWidgetState
  ...
  void _clearTransientAttachmentState() {
    FFAppState().photos = [];
    FFAppState().update(() {
  ...
  String _requestCriticality(dynamic body) {
    final v = getJsonField(body, r'''$.criticality''')?.toString();
    if (v != null && v.isNotEmpty && v != 'null') {
      return v;
    }
    return getJsonField(body, r'''$.priority_request''')?.toString() ?? '';
  }
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _clearTransientAttachmentState();
      safeSetState(() {});
    });
                                                                    ...
                                                                    options:
                                                                      ...
                                                                      iconPadding:
                                                                          EdgeInsetsDirectional.fromSTEB(
                                                                              ...
                                                                              0,
                                                                              0),
                                                                      color: _requestCriticality(detailedDefectsOfflineGetDefectsByIDResponse.jsonBody) ==
                                                                              'low'
                                                                          ? FlutterFlowTheme.of(context).primary
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                FFLocalizations.of(context).getVariableText(
                                                                                  ruText: 'Дата создания',
                                                                                  kkText: 'Құрылған күні',
                                                                                ),
                                                                                textAlign: TextAlign.start,
                                                                                style: FlutterFlowTheme.of(context).bodySmall.override(
                                                                                      fontFamily: 'SFProText',
                                                              ...
                                                              Builder(
                                                                builder:
                                                                  ...
                                                                  final questions = (getJsonField(
                                                                        ...
                                                                        r'''$.form_result''',
                                                                        true,
                                                                      )?.toList().map<FormResultStruct?>(FormResultStruct.maybeFromMap).toList() as Iterable<FormResultStruct?>)
                                                                          .withoutNulls
                                                                          .toList() ??
                                                                      [];
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              if (questionsItem.type == functions.stringToJson('\"radio_defect\"').toString()) {
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              if (confirmDialogResponse) {
                                                                                ...
                                                                                safeSetState(() {});
                                                                                _model.apiResur = await UpdateDefectsByIdCall.call(
                                                                                  access: currentAuthenticationToken,
                                                                                  id: getJsonField(
                                                                                    detailedDefectsOfflineGetDefectsByIDResponse.jsonBody,
                                                                                    r'''$.id''',
                                                                                  ),
                                                                                  bodyJson: buildFullRequestPutBody(
                                                                                    defectJsonBody:
                                                                                        detailedDefectsOfflineGetDefectsByIDResponse.jsonBody,
                                                                                    works: FFAppState().works,
                                                                                    spareParts: FFAppState().spareparts,
                                                                                    combinedFileJsonList: functions
                                                                                        .combineArrays(
                                                                                  ...
                                                                                  var confirmDialogResponse = await showDialog<bool>(
                                                                                        ...
                                                                                        builder: (alertDialogContext) {
                                                                                          return AlertDialog(
                                                                                            ...
                                                                                            content: Text(
                                                                                              FFLocalizations.of(context).getVariableText(
                                                                                                ruText: 'Вы точно хотите удалить ТМЦ?',
                                                                                                kkText: 'ТМҚ-ны жойғыңыз келетініне сенімдісіз бе?',
                                                                                              ),
                                                                                            ),
                                                                                            actions: [
                                                                                              TextButton(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              highlightColor:
                                                                  Colors
                                                                      .transparent,
                                                              onTap: () async {
                                                                if ((_model.nameTextController2.text !=
                                                                            null &&
                                                            ...
                                                            builder: (context) {
                                                              ...
                                                              final serverCount =
                                                                  _model
                                                                      .photos123
                                                                      .length;
                                                              final canRemoveServer = ((functions
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: List
                                                                    ...
                                                                    final isServer =
                                                                        index <
                                                                            serverCount;
                                                                    final urlPath = getJsonField(
                                                                            item,
                                                                            r'''$.url''')
                                                                        .toString();
                                                                    final fullUrl =
                                                                        _attachmentFullMediaUrl(
                                                                            urlPath);
                                                                    final isVideo =
                                                                        _attachmentItemIsVideo(
                                                                            item);
                                                                    final label =
                                                                        _attachmentItemDisplayName(item)
                                                                            .trim();
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                if (isServer && canRemoveServer)
                                                                                  IconButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      final combinedFiles = functions
                                                                                          .combineArrays(
                                                                                              _model.photos123.toList(),
                                                                                              FFAppState().photos.toList())
                                                                                          .toList();
                                                                                      combinedFiles.removeAt(index);
                                                                                      final resp = await UpdateDefectsByIdCall.call(
                                                                                        access: currentAuthenticationToken,
                                                                                        id: getJsonField(
                                                                                          detailedDefectsOfflineGetDefectsByIDResponse
                                                                                              .jsonBody,
                                                                                        ...
                                                                                        bodyJson: buildFullRequestPutBody(
                                                                                          ...
                                                                                          works: FFAppState().works,
                                                                                          spareParts: FFAppState().spareparts,
                                                                                          combinedFileJsonList: combinedFiles,
                                                                                        ),
                                                                                      );
                                                                                      if (resp.succeeded) {
                                                                                        _model.removeAtIndexFromPhotos123(index);
                                                                                        safeSetState(() {});
                                                                                      }
                                                                                    },
                                                                                  ),
                                                                                if (!isServer)
                                                                                  IconButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      if (resp.succeeded) {
                                                                                        FFAppState().removeAtIndexFromPhotos(index - serverCount);
                                                                                        safeSetState(() {});
                                                                                      }
                                                                                    },
                                                                                  ),
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      safeSetState(
                                                                        ...
                                                                        _model.isDataUploading_uploadD1112 =
                                                                            false;
                                                                        _model.uploadedLocalFile_uploadD1112 = FFUploadedFile(
                                                                            bytes:
                                                                                Uint8List.fromList([]),
                                                                            originalFilename:
                                                                                '');
                                                                      ...
                                                                      final _localPhoto =
                                                                          _model.uploadedLocalFile_uploadD1112;
                                                                      if (_localPhoto.bytes ==
                                                                              null ||
                                                                          _localPhoto.bytes!.isEmpty) {
                                                                        return;
                                                                      }
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        FFAppState()
                                                                            .update(() {
                                                                          FFAppState().videoAttachmentUploadBusy =
                                                                              false;
                                                                          FFAppState().videoAttachmentUploadPhase =
                                                                              '';
                                                                        });
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      ].addToStart(SizedBox(height: 10.0)).addToEnd(
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: LinearProgressIndicator(
                                    // На iOS прогресс может не приходить (останется 0.0) —
                                    // тогда показываем «двигающийся» индикатор.
                                    value: (FFAppState()
