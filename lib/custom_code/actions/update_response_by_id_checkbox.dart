...
Future<void> updateResponseByIdCheckbox(dynamic inspectionJson, int equipmentId,
    String formTitle, String checkboxText, bool newResponse) async {
                ...
                for (var checkbox in formResult['data']['checkboxes']) {
                  ...
                  if (checkbox is Map &&
                    ...
                    if (checkbox.containsKey('result') &&
                      ...
                      checkbox['result']['response'] = newResponse;
                      print(
