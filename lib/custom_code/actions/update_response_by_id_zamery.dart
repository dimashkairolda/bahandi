...
Future<void> updateResponseByIdZamery(dynamic inspectionJson, int equipmentId,
    String formTitle, String newResponse) async {
          ...
          for (var formResult in response['form_result']) {
            ...
            if (formResult is Map &&
              ...
              if (formResult.containsKey('result') &&
                ...
                print(
                    'Response (zamery) для "$formTitle" обновлен на "$newResponse"');
                updated = true;
