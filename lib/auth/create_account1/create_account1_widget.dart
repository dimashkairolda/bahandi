...
class _CreateAccount1WidgetState extends State<CreateAccount1Widget> {
  ...
  void initState() {
    ...
    _model.fathersnameTextController ??= TextEditingController();
    _model.fathersnameFocusNode ??= FocusNode();
    ...
    _model.repassTextController ??= TextEditingController();
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.fathersnameTextController,
                                      focusNode: _model.fathersnameFocusNode,
                                      autofocus: true,
                                      autofillHints: [AutofillHints.name],
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      validator: _model
                                          .fathersnameTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ]
