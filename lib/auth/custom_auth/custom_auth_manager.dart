...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bahandiAuthUserSubject.add(
      BahandiAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BahandiAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BahandiAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BahandiAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    bahandiAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
