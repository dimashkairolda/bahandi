...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3466E7);
  late Color secondary = const Color(0xFFEFF1F3);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF8A8A8A);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF8291B0);
  late Color primaryBackground = const Color(0xFFEEF1F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFFEFEFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFD0D5E1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3466E7);
  late Color secondary = const Color(0xFF1E232F);
  late Color tertiary = const Color(0xFFEE8B60);
  ...
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFF1A2A50);
  late Color accent3 = const Color(0xFF1E232F);
  late Color accent4 = const Color(0xFF1E232F);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFF3C465D);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
}
