...
import 'short_text_model.dart';
export 'short_text_model.dart';
...
class ShortTextWidget extends StatefulWidget {
  ...
  @override
  State<ShortTextWidget> createState() => _ShortTextWidgetState();
}

class _ShortTextWidgetState extends State<ShortTextWidget> {
  late ShortTextModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortTextModel());
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          FFAppState().updateFormresult1AtIndex(
                            ...
                            (e) => e
                              ..updateResult(
                                (e) => e..response = _model.textController.text,
                              ),
                          );
                          FFAppState().update(() {});
                        },
