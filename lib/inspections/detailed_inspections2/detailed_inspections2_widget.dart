...
import 'detailed_inspections2_model.dart';
export 'detailed_inspections2_model.dart';

class DetailedInspections2Widget extends StatefulWidget {
  const DetailedInspections2Widget({
    super.key,
    required this.name,
    required this.index,
    this.nextIndex,
  ...
  static String routeName = 'detailedInspections2';
  static String routePath = '/detailedInspections2';

  @override
  State<DetailedInspections2Widget> createState() =>
      _DetailedInspections2WidgetState();
}

class _DetailedInspections2WidgetState
    extends State<DetailedInspections2Widget> {
  late DetailedInspections2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailedInspections2Model());
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  context.pushNamed(
                    DetailedInspections2Widget.routeName,
                    queryParameters: {
                      'name': serializeParam(
                        widget!.name,
                        ParamType.JSON,
