...
import 'zamery_copy_model.dart';
export 'zamery_copy_model.dart';

class ZameryCopyWidget extends StatefulWidget {
  const ZameryCopyWidget({
    super.key,
    required this.data,
  ...
  @override
  State<ZameryCopyWidget> createState() => _ZameryCopyWidgetState();
}

class _ZameryCopyWidgetState extends State<ZameryCopyWidget> {
  late ZameryCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZameryCopyModel());
