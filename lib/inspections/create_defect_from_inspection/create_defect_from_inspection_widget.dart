                        ...
                        FlutterFlowDropDown<String>(
                          ...
                          onChanged: (val) async {
                            ...
                            if (functions.hasStuff(
                              ...
                              context.pushNamed(
                                CreateDefectFromInspectionCopyWidget.routeName,
                                queryParameters: {
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_uploadDataTbt123 =
                                          true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_uploadDataTbt123 =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadDataTbt123 =
